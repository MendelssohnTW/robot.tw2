			...
			return $timeout(
					function(){
						...
						villages.forEach(function(village){
							...
							console.log("presets_order = " + presets_order.name + "/" + presets_order.id)
						...
						console.log("commands_for_presets = " + commands_for_presets.village_id + "/" + commands_for_presets.prest_id)
